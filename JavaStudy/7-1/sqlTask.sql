...
-- [回答]
SELECT *
FROM store_table ORDER BY store_nameAbc;
...
SELECT
	...
	goods_name AS 商品名,
	quantity AS 在庫数
FROM stock_table AS SKT
	INNER JOIN store_table AS SRT ON SKT.store_code = SRT.store_code
	INNER JOIN goods_table AS GST ON SKT.goods_code = GST.goods_code; 
